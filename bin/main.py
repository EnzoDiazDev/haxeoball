...
class Main:
    ...
    def main():
        ...
        response = src_Oball().ask(question)
        print(str(("─ " + ("null" if response is None else response))))
...
class src_Oball:
    _hx_class_name = "src.Oball"
    __slots__ = ("responses",)
    _hx_fields = ["responses"]
    _hx_methods = ["ask"]

    def __init__(self):
        self.responses = ["Y... Yo creo que sí.", "Es cierto.", "Sin lugar a dudas xd", "Sí.", "Dalo por hecho.", "Si te lo digo no me vas a creer.", "Si te digo lo que pasará, no ocurrirá.", "Según mis cálculos... Los cálculos no dicen nada.", "Ni lo confirmo ni lo desmiento.", "Es complicado...", "No.", "No lo creo.", "Mi IA dice que no es así.", "No cuentes con ello.", "Claro que no.", "Búscate la respuesta tú mismo."]

    def ask(self,question):
        return python_internal_ArrayImpl._get(self.responses, Math.floor((python_lib_Random.random() * len(self.responses))))
